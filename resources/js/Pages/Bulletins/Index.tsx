...
export default function BulletinsIndex({ documents, filters }: BulletinsIndexProps) {
    return (
        <AppLayout>
            <Head title="Buletin - Digital Document Storage" />
            
            {/* Header Section */}
            <div className="bg-gradient-to-br from-purple-50 to-violet-100 py-12">
                <div className="container mx-auto px-4 text-center">
                    <BookOpen className="mx-auto text-4xl text-purple-600 mb-4 w-16 h-16" />
                ...
                {documents.data.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                        <div className="text-[var(--text-secondary)] text-lg mb-4">
                            Tidak ada buletin yang ditemukan
                        </div>
